...
function UpperPart({ propHandleClose, propOpen }) {
  ...
  const isDetailOpen = propOpen !== undefined ? propOpen : isOpen;
    ...
    <div className='border-y-2 border-gray-100 flex items-center justify-between border-t border-b border-gray-300 py-5'>
      <div className=''>
        ...
        <div className='flex space-x-4 items-end'>
          ...
          <span className='bg-red-50 text-red-400 text-custom-sm rounded px-[5px] text-center pt-0'>Bugs</span>
        </div>
      </div>
      
      {/* Right Side */}
      <div className='flex items-center space-x-2'>
        <div className='py-[7px] px-[8px] border-[1.7px] border-gray-200 rounded'>
          <FaCog className='text-custom-lg text-gray-600'/>
        </div>
        <div className='py-[7px] px-[8px] border-[1.7px] border-gray-200 rounded'>
